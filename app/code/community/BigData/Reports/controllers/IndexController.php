...
*/ 
class BigData_Reports_IndexController extends Mage_Core_Controller_Front_Action {
    ...
    */ 
    public function indexAction() { 
        $this->loadLayout()
                ->getLayout()
                ->getBlock('root')
                ->setTemplate('reports/base.phtml');
    ...
    public function paymentMethodPieChartAction() {
    ...
    public function getDataAction() {
       ...
       // $response[] = array('default_name' => 'Provincia', 'count' => '# de Ventas');
        $response[] = array( 'Provincia', 'Ventas [ARS]');
